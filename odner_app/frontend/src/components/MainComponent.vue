...
export default {
    ...
    methods: {
        ...
        uploadFile() {
            ...
            if (file == null) {
                ...
                if (file.type === "application/pdf") {
                    ...
                    axios
                        .post("https://localhost:8000/api/pdf-upload/", formData)
                        .then(response => {
                    ...
                    axios
                        .post("https://localhost:8000/api/word-upload/", formData)
                        .then(response => {
                            // If the language is Italian, set the text and TXT file to the Italian versions.
                            if (this.language === "it") {
                    ...
                    axios
                        .post("https://localhost:8000/api/xlsx-upload/", formData)
                        .then(response => {
                            // If the language is Italian, set the text and TXT file to the Italian versions.
                            if (this.language === "it") {
        ...
        updateText() {
            ...
            axios.post("https://localhost:8000/api/update-text/", {
        ...
        filter() {
            // Send a POST request to the specified API endpoint with the following data:
            axios.post("https://localhost:8000/api/filter/", {
                // The path to the text file to be analyzed
                file_txt_path: this.txt_file,
                // The language of the text
                language: this.language,
        ...
        question_answering() {
            ...
            // Send a POST request to the specified API endpoint with the following data:
            axios.post("https://localhost:8000/api/qa/", {
        ...
        saveQuestion() {
            ...
            axios.post("https://localhost:8000/api/save-question/", {
        ...
        changeConfig() {
            ...
            axios.post("https://localhost:8000/api/change-cnf/", { config_name: this.config_to_change, txt: this.txt_file, language: this.language, context: this.text })
                .then(response => {
        ...
        deleteEn() {
            ...
            axios.post("https://localhost:8000/api/delete-entities/", { "file_config": this.file_config, "entities": this.todelete_entities })
                .then(response => {
                    // If the response from the API contains an error code, display an alert with the error message.
                    if (response.data.cod == -1) {
                        alert(response.data.res);
